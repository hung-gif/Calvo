      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            _buildSectionHeader(Icons.palette, t('appearance'), isDark, primaryColor),
            const SizedBox(height: 12),
            ...
            Center(child: Text("Calvo v1.0.0 • Made with ❤️", style: TextStyle(color: isDark ? Colors.white54 : Colors.grey, fontSize: 12))),
          ],
        ),
      ),
    );
